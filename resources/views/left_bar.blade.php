...
6.7V17h2v-2.3c.6-.3 1-1 1-1.7 0-1-1-2-2-2s-2 1-2 2c0 .7.4 1.4 1 1.7zM6 6v2h6V6c0-1.7-1.3-3-3-3S6 4.3 6 6z "></path>
            ...
            <li class="nav-item ">
                    ...
                    <a class="nav-link" href="{{ url('smtp-configure') }}">
...
1 .5 1 1v1zm1 18c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2zm10 0c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2z"></path>
                ...
                <li class="nav-item ">
                    ...
                    <a class="nav-link" href="{{ url('company-info') }}" >
...
1 .5 1 1v1zm1 18c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2zm10 0c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2z"></path>
                ...
                <li class="nav-item ">
                    ...
                    <a class="nav-link" href="{{ url('extra-mail-field') }}" >

                        <svg class="icon-20 " xmlns="http://www.w3.org/2000/svg " viewBox="0 0 20 20 ">

                            <path d="M4 2h16l-3 9H4c-.6 0-1 .4-1 1s.5 1 1 1h13v2H4c-1.7 0-3-1.3-3-3s1.3-3 3-3h.3L3 5 2 2H0V0h3c.5 0 1 .5 1 1v1zm1 18c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2zm10 0c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2z"></path>

                        </svg>

                        {{__('Extra Field Configured')}}
            ...
            <ul class="nav flex-column mb-4 ">
                ...
                @if (Spark::hasPaidPlans())
                    ...
                    <li class="nav-item ">
                        ...
                        <a class="nav-link" href="{{ url('settings#/subscription') }}" >
...
2 5 0 4-3 7-7 7v-2c2.8 0 5-2.2 5-5 0-1.4-.6-2.6-1.5-3.5L12 5zM7 20l-4-4 4-4v8zM7 8V0l4 4-4 4z"></path>
                ...
                <li class="nav-item ">
                    ...
                    <a class="nav-link" href="{{ url('settings#/payment-method') }}">
...
8h4v2H4v-2z"></path>
                ...
                <li class="nav-item ">
                    ...
                    <a class="nav-link" href="{{ url('settings#/invoices') }}">
