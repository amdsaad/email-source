        ...
        <div class="container" v-if="user">
            ...
            <div id="navbarSupportedContent" class="collapse navbar-collapse">
                ...
                <ul class="navbar-nav ml-4">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('mail-service') }}"><span>Home</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/google-inbox') }}"><span>Gmail Mail</span></a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/g-send-mail') }}"><span>Send Mail</span></a>
                    </li>


                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('template') }}"><span>Template</span></a>
                    </li>


                    @if(count(Auth::user()->ownedTeams) > 0)
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('statistics') }}"><span>Statistics</span></a>
                    </li>
                    @endif
